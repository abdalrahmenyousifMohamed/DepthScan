...
class IterativeResearcher:
    ...
    async def _evaluate_gaps(
        ...
        print(f"result of knowledge_gap_agent : {result}")
        # evaluation = get_KnowledgeGapOutput(result)
        
        evaluation = result.final_output_as(KnowledgeGapOutput)
        print(f"evaluation KnowledgeGapOutput: {evaluation}")
    ...
    async def _select_agents(
        ...
        print(f"result of tool_selector_agent : {result}")
        
        selection_plan = result.final_output_as(AgentSelectionPlan)
        print(f"selection_plan AgentSelectionPlan: {selection_plan}")
        # print(f"[Agent] {task.agent} [Query] {task.query} [Entity] {task.entity_website if task.entity_website else 'null'}" for task in selection_plan.tasks)
    ...
    async def _generate_observations(self, query: str, background_context: str = "") -> str:
        ...
        print(f"result of thinking_agent : {result}")
        ...
        print(f"observations : {self.conversation.latest_thought_string()}")
        return observations
